...
import {getArtistSimilar, getArtistDescription, getArtistAlbum, getArtistFansNumber} from "../../common/service/artist";
...
import followers from "../../assets/image/followers.svg"
...
function Singer(){
  ...
  const [singer_fans,setsinger_fans]= useState([]);
  ...
  async function getData12(){
    ...
    let artist3 = await getArtistFansNumber(id)
    console.log("FFFFFFF",artist3.data.fansCnt)
    setsinger_fans(artist3&&artist3.data.fansCnt)
      ...
      <div className="singerWrap">
        <div className='singer_info'>
          ...
          <div className='singer_image'>
            ...
            <div className='singer_fans'>
              <img src={followers}/>
              Followers: {singer_fans}
            </div>
          </div>
